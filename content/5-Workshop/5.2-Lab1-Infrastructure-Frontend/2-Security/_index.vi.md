...
# 2. Cấu hình Security (Security Group & IAM Role)
...
6. **Inbound rules**:
   ...
   - Thêm Rule 2: Type `HTTPS`, Source `Anywhere-IPv4` (`0.0.0.0/0`) *(Chỉ bắt buộc nếu có chứng chỉ SSL)*.
...
---
**Chúc mừng!** Tường lửa bảo vệ tầng Network và quyền IAM đã được thiết lập xong. Bước tiếp theo, ta sẽ chuyển sang triển khai Frontend.
